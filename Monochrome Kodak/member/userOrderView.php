...
<body>
    ...
    <div class="row container bg-light" style="margin: 50px; padding:20px; border-radius: 20px;">
        ...
        <div class="col-9" style=" display:flex; justify-content: flex-end;">
            <button class="btn btn-warning text-light" style="margin: 5px;">Order Place</button>
            <button class="btn btn-warning text-light" style="margin: 5px;">Accepted</button>
            <button class="btn btn-warning text-light" style="margin: 5px;">Decline</button>
            <button class="btn btn-warning text-light" style="margin: 5px;">Completed</button>
        </div>
